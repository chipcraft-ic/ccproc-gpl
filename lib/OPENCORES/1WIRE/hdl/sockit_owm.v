...
`endif
  ...
  input wire  [BAW-1:0] bus_adr,  // address
  input wire  [BDW-1:0] bus_wdt,  // write data
  output wire [BDW-1:0] bus_rdt,  // read  data
  output wire           bus_irq,  // interrupt request
  // 1-wire interface
  output wire [OWN-1:0] owr_p,    // output power enable
  output wire [OWN-1:0] owr_e,    // output pull down enable
  input wire  [OWN-1:0] owr_i     // input from bidirectional wire
);
